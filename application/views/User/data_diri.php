  ...
  <body>
    ...
    <section class="hero bg-top" id="hero">
      <div class="container">
        <div class="row py-5">
            <div class="col-lg-12">
                <h1 class="font-weight-bold text-center">Isi data diri</h1>
                <p class=" text-muted ">Mohon isi data diri kamu dulu yaa...</p>
            </div>
            <form method="post" class="col-lg-12">
                <div class="my-4">
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            ...
                            <span class="text-danger"><?php echo form_error('nama_tengah'); ?></span>
                        </div>
                        <div class="col-md-3">
                ...
                <div class="my-4">
                    <div class="row">
                        ...
                        <div class="col-md-9">
                            <textarea class="form-control" name="alamat" placeholder="Jl Sultan Agung Km 28,5 , Bekasi Barat, Bekasi"></textarea>
            ...
            <div class="col-lg-12">
                ...
                <div class="row pb-5">
                    ...
                    <div class="card border-0 bg-primary shadow rounded-lg py-4 text-left">
                        ...
                        <h3 class="font-weight-normal h4 my-4 text-white">Isi data diri</h3>
                        <p class="text-small mb-0 text-white">Proses ini diperlukan agar kami mengetahui data diri kamu</p>
                        </div>
                    </div>
                    </div>
                    <div class="col-lg-4 col-md-6 mb-4 mb-lg-0">
